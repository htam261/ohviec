 ...
 */ 
 var Tshirt = require('../models/tshirt.js');
	...
	* @param {Object} res HTTP response object.
 	*/
module.exports.findAllTshirts = function (req, res) {
		console.log("GET - /tshirt");
		return Tshirt.find(function (reqerr, tshirts) {
			if (!err) {
...
module.exports.findById = function (req, res) {
 	...
 	*
 	*/
 	module.exports.addTshirt = function (req, res) {
 	...
 	* @param {Object} res HTTP response object.
 	*/
 	module.exports.updateTshirt = function (req, res) {
 	...
 	*
 	*/
 	module.exports.deleteTshirt = function (req, res) {
